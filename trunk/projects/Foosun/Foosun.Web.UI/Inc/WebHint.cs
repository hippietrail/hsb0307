...
namespace Foosun.Web.UI
{
    public class WebHint
    {
        ...
        static internal void PageRender(string Msg, string Url, bool Succeed, bool returnUrl,bool noHistory)
        {
            ...
            System.Web.HttpContext.Current.Response.Write("    <table style=\"width:65%;height:250px;\"  border=\"0\" align=\"center\" cellspacing=\"1\" cellpadding=\"5\" class=\"table\">\r   <tr class=\"TR_BG\"><td class=\"sysmain_navi\" style=\"height:38px;\" colspan=\"2\">" + SCaption + "</td>\r");
