...
<body onload="loadStat();">
   ...
   <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="toptable">
    ...
    <tr>
      ...
      <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px"><div align="left">λõ<a href="../main.aspx" target="sys_main" class="list_link">ҳ</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="siteTask.aspx" class="list_link">ƻ</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />޸ļƻ</div></td>
    </tr>
  </table>
 <table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="Navitable">
  ...
  <table width="98%" border="0" cellpadding="5" align="center" cellspacing="1" class="table" id="base">
    ...
    <tr class="TR_BG_list" id="IsTimee">
      ...
      <option value="24">24</option></select><span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_0012',this)"></span></td>
    </tr>
   ...
   %>
    <tr class="TR_BG_list" id="class_class">
      <td align="right"  class="list_link" style="width: 178px">Ŀ</td>
      <td  align="left" class="list_link"><div id="divClassNews" runat="server" style="padding-bottom:0;padding-left:0;padding-right:0;padding-top:0;" align="left"></div><div id="aaa" align="center" runat="server"><span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_0007',this)"></span></div></td>
    </tr>
    ...
    <tr class="TR_BG_list" id="newsidd"  style="display:none" align="right">
      ...
      <td  align="left" class="list_link"> <asp:TextBox ID="NewsID1" runat="server" Width="66px"/>  <asp:TextBox ID="NewsID2" runat="server" Width="66px"/><span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_0009',this)"></span></td>
    </tr>
    ...
    <tr class="TR_BG_list" id="lastnumm" style="display:none" >
      ...
      <td  align="left" class="list_link">ɵ:<asp:TextBox ID="LastNewsNum" runat="server" Width="66px" />&nbsp;<span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_0011',this)"></span></td>
    </tr>
        
    <tr class="TR_BG_list" id="news_class" >
      <td align="right"  class="list_link" style="width: 178px">Ŀ</td>
      <td  align="left" class="list_link"><div id="divClassClass" runat="server" style="padding-bottom:0;padding-left:0;padding-right:0;padding-top:0;" align="left"></div><div id="Div2" align="center" runat="server"><span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_0007',this)"></span></div></td>
    </tr>
     <tr class="TR_BG" id="special_tr">
      ...
      <td  align="left" class="list_link"><div id="DivSpecial" runat="server" style="padding-bottom:0;padding-left:0;padding-right:0;padding-top:0;" align="left"></div><div id="Special_span" align="center" runat="server"><span class="helpstyle" style="cursor:help;" title="鿴" onClick="Help('H_task_00013',this)"></span></div></td>
    </tr>
