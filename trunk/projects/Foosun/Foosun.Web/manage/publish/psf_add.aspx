...
<body>
  ...
  <table width="98%" border="0" cellpadding="5" align="center" cellspacing="1" class="table" id="OM_AddNew">
    ...
    <tr class="TR_BG_list">
      <td  align="right" style="width: 178px; height: 24px;" class="list_link">ӵ:</td>
    ...
    <tr class="TR_BG_list">
      <td align="right" class="list_link" style="width: 178px; height: 34px;" valign="top">ӵĿ¼ϵ</td>
      <td align="left" style="height: 34px"><div id="default" style="margin-bottom:1px;"> Ŀ¼ <input name="LocalDir" type="text" style="width:130px;" maxlength="200" value="" class="form" id="LocalDir"/> Զ̷Ŀ¼ <input name="RemoteDir" type="text" id="RemoteDir" value="" style="width:130px;" maxlength="100" class="form" />(<font color="red">*</font>)<span class="helpstyle" onclick="Help('H_psf_0006',this)" style="cursor: help;" title="鿴"></span>&nbsp;<font color="red">(<a href="javascript:psf_add()" class="list_link"><font color="red"><strong></strong></font></a>)</font></div><div id="temp"></div></td>
    </tr>
    <tr class="TR_BG_list">
    ...
    <tr class="TR_BG_list">
      <td align="right"  class="list_link" style="width: 178px">ϴĿ¼µļ</td>
    ...
    <tr class="TR_BG_list">
      <td align="right"  class="list_link" style="width: 178px"> ڣ</td>
