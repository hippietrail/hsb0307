<%@ Page Language="C#" AutoEventWireup="true" ResponseEncoding="utf-8" Inherits="manage_user_usergroupadd" Codebehind="usergroupadd.aspx.cs" %>
    ...
    <form id="form1" runat="server">
     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="toptable">
            ...
            <tr>
              ...
              <td width="43%" height="32" class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="userGroup.aspx" class="list_link">会员组管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />添加会员组</div></td>
            </tr>
    </table>
    
          <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
            <tr>
              <td style="padding-left:14px;"><a class="topnavichar" href="usergroup.aspx">会员组管理</a>　<a class="topnavichar" href="usergroupadd.aspx"><font color="red">创建会员组</font></a>　　</td>
            </tr>
    </table>
      ...
      <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
        ...
        <tr class="TR_BG_list">
          <td class="list_link" style="width: 149px"><div align="right">
              支持群发消息</div></td>
          <td class="list_link">
           <asp:TextBox ID="MessageGroupNum" CssClass="form" Text="0|10" runat="server"></asp:TextBox>
