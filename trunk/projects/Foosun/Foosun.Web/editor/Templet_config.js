...
FCKConfig.ToolbarSets["Foosun_Templet"] = [
	['Source','Cut','Copy','Paste','PasteText','PasteWord','TextColor','BGColor','JustifyLeft','JustifyCenter','JustifyRight','Bold','Italic','-','OrderedList','UnorderedList','Link','Unlink','-','Image','Table','Undo','Redo','-','Find','Replace','-','SelectAll','SpecialChar']
] ;
...
FCKConfig.FontNames		= 'Arial; 瀹嬩綋; 榛戜綋; 闅朵功; 妤蜂綋_GB2312;Comic Sans MS;Courier New;Tahoma;Times New Roman;Verdana' ;
