  ...
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" class="table">
    ...
    <tr class="TR_BG_list">
      ...
      <td width="11%" rowspan="4" align="left" valign="middle" style="width: 10%">
          <asp:ListBox ID="NewsClassList" SelectionMode="Multiple" runat="server" Height="120px" Width="200px" CssClass ="SpecialFontFamily"></asp:ListBox></td>
      ...
      <td width="27%" rowspan="4" align="left" valign="middle" style="width: 10%">
          <asp:ListBox ID="NewsClassList2"  SelectionMode="Multiple" runat="server" Height="120px" Width="200px" CssClass="SpecialFontFamily"></asp:ListBox></td>
    ...
    <tr class="TR_BG_list">
      ...
      <td rowspan="4" align="left" valign="middle">
          <asp:ListBox ID="Special1" SelectionMode="Multiple" runat="server" Height="120px" Width="200px" CssClass ="SpecialFontFamily"></asp:ListBox></td>
      <td align="center">
          <input id="Button3" class="form" name="button2" onclick="javascript:Selectone(document.F_AdminGroup.Special1,document.F_AdminGroup.Special2,document.getElementById('Span3'),document.F_AdminGroup.Sp_List);"
              type="button" value=" 选  中 " /></td>
      <td rowspan="4" align="left" valign="middle">
          <asp:ListBox ID="Special2" SelectionMode="Multiple" runat="server" Height="120px" Width="200px" CssClass ="SpecialFontFamily"></asp:ListBox></td>
