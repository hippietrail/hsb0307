...
<form id="form1" runat="server">
  ...
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
    <tr class="TR_BG_list">
      ...
      <td Width="90%" align="left"><asp:TextBox ID="TxtUserName" CssClass="form" runat="server" Width="200px" MaxLength="18"></asp:TextBox>(<font
              color="red" size="2">*</font>)<span class="helpstyle" onclick="Help('H_GenTitle_0001',this)"
                  style="cursor: help" title="点击查看帮助"></span><span class="helpstyle" style="cursor:help;" title="点击显示帮助" onclick="Help('H_adminAdd_001',this)">帮助</span><asp:RequiredFieldValidator ID="RequireUserName" runat="server" ControlToValidate="TxtUserName" Display="Dynamic" ErrorMessage="<span class=reshow>(*)请填写用户名</spna>"></asp:RequiredFieldValidator>
        </td>
    </tr>
    <tr class="TR_BG_list">
    ...
    <tr class="TR_BG_list">
      ...
      <td Width="90%" align="left"><asp:TextBox ID="SecUserPwd" CssClass="form" runat="server" Width="200px" MaxLength="50" TextMode="Password"></asp:TextBox>(<font
              color="red" size="2">*</font>)<span class="helpstyle" onclick="Help('H_GenTitle_0001',this)"
                  style="cursor: help" title="点击查看帮助"></span>
    ...
    <tr class="TR_BG_list">
      ...
      <td Width="90%" align="left"><asp:TextBox CssClass="form" ID="Email" runat="server" Width="200px" MaxLength="120"></asp:TextBox>(<font
              color="red" size="2">*</font>)<span class="helpstyle" onclick="Help('H_GenTitle_0001',this)"
                  style="cursor: help" title="点击查看帮助"></span><span class="helpstyle" style="cursor:help;" title="点击显示帮助" onclick="Help('H_adminAdd_006',this)">帮助</span><asp:RequiredFieldValidator ID="RequiredEmail" runat="server" ControlToValidate="Email" Display="Dynamic" ErrorMessage="<span class=reshow>(*)请填写电子邮件</span>"></asp:RequiredFieldValidator>
