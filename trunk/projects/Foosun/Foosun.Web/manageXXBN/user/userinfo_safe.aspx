...
<body>
     ...
     <table width="100%" border="0" cellpadding="0" cellspacing="0" class="toptable">
            ...
            <tr>
              ...
              <td width="43%" height="32" class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="userlist.aspx" class="list_link">会员管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />安全资料</div></td>
            </tr>
    </table>
          <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
            <tr>
              <td style="padding-left:14px;"><a class="topnavichar" href="userinfo.aspx?id=<% Response.Write(Request.QueryString["id"]);%>">基本信息</a>　<a class="topnavichar" href="userinfo_contact.aspx?id=<% Response.Write(Request.QueryString["id"]);%>">联系资料</a>　<a class="topnavichar" href="userinfo_safe.aspx?id=<% Response.Write(Request.QueryString["id"]);%>"><font color="red">安全资料</font></a>　<a class="topnavichar" href="userinfo_base.aspx?id=<% Response.Write(Request.QueryString["id"]);%>">基本状态/实名认证</a></td>
            </tr>
    </table>
      ...
      <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
        ...
        <tr class="TR_BG_list">
          ...
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_userinfo_safe_0004',this)">帮助</span><asp:RequiredFieldValidator ID="f_oldpassword" runat="server" ControlToValidate="oldpassword" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)请填写新密码，长度为3-18</span>"></asp:RequiredFieldValidator></td>
          </tr>
