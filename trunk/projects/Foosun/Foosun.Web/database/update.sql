...
INSERT INTO [dbo].[fs_sys_Label] (
	...
	SELECT 201, '324310793293', '932462318447', '{FS_people_贝叶文化图文}', '[FS:Loop,FS:SiteID=0,FS:LabelType=List,FS:Number=6,FS:NewsType=Last,FS:ClassID=939459291685,FS:Cols=1,FS:Desc=desc,FS:DescType=date,FS:isPic=true,FS:TitleNumer=20][#FS:StyleID=009016332516][/FS:Loop]', '', '10-29-2009 15:02:17.110', 0, 0, 0, '0', NULL 
