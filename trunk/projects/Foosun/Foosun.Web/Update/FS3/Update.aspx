<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="Foosun.Web.Update.FS3.Update" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
<head>
<title>迅捷3.x升级到dotNETCMS v1.0正式版</title>
    ...
    <form id="form1" runat="server">
      <div style="margin:10px auto 10px auto;width:800px;background-color:#fff;border:1px solid #eeeeee;">
        ...
        <div style="float:right;margin:15px;">
            ...
            <span style="color:Blue;font-size:16px;font-weight:bold;">迅捷3.x升级到dotNETCMS v1.0正式版转换程序。</span>
            </div>
            <div style="margin:10px auto 10px auto;width:550px;">
           ...
           <div style="margin:10px auto 10px auto;width:550px;text-align:left;">本程序只适合数据量小于8万条记录的客户，如果超过8万条数据记录，请与迅捷官方联系。转换数据包括：新闻，栏目，专题，会员，常规管理。如果您要转换标签，请与官方联系(收费服务)</div> 
