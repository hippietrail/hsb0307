...
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" class="toptable">
  ...
  <tr>
    ...
    <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="topnavichar">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />常规管理</div></td>
  </tr>
</table>
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="1" class="Navitable">
  <tr>
    <td height="18" style="width: 45%;PADDING-LEFT: 14px" colspan="2"><div align="left"><font color="#ff0000">功能:</font> ┊ <a href="General_manage.aspx" class="topnavichar">管理首页</a> ┊ <a href="General_Add_Manage.aspx" class="topnavichar">添加</a> ┊ <a href="General_manage.aspx?key=0" class="topnavichar" onclick=""> 关键字(TAG)</a> ┊ <a href="General_manage.aspx?key=1" class="menulist">来源</a> ┊ <a href="General_manage.aspx?key=2" class="topnavichar">作者</a> ┊ <a href="General_manage.aspx?key=3" class="topnavichar">内部链接</a> ┊ <a href="General_manage.aspx?type=delall" onclick="{if(confirm('确认删除全部所有添加的信息吗？')){return true;}return false;}" class="topnavichar">删除全部</a></div></td>
  </tr>
</table>
<form id="form1" runat="server" onsubmit="javascript:return check();">
  <table width="98%" border="0" cellpadding="5" align="center" cellspacing="1" class="table" id="OM_AddNew">
    <tr class="TR_BG_list">
      <td colspan="2" class="list_link"><strong>添 加</strong></td>
    </tr>
    <tr class="TR_BG_list">
    ...
    <tr id="Tr_SubMit" class="TR_BG_list" style="display:none">
      <td align="center" class="list_link" colspan="2" height="-5" style="height: 32px"><input type="submit" id="But_AddNew" name="But_AddNew" value="保 存"  class="form" runat="server" onserverclick="But_AddNew_ServerClick" />
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        <input type="submit" id="But_Clear" name="But_Clear" value="重 置" class="form" runat="server" />
