...
<body>
    <form id="form1" runat="server">
      <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="toptable">
        <tr>
          <td width="57%" class="sysmain_navi"  style="PADDING-LEFT: 14px" Height="30"><span id="adress"></span>修改标签</td>
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="SysLabel_List.aspx" class="list_link">标签管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />修改标签</div></td>
        </tr>
      </table>
  ...
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
    ...
    <tr class="TR_BG_list" id="Tr_Content">
      ...
      <a href="javascript:show('List',document.getElementById('adress'),'选择标签参数(列表类(繁))',700,420);"  class="list_link" title="包括最新、推荐、热点、头条、滚动、专题、公告、子类">列表类</a> &nbsp; 
      <a href="javascript:show('Ultimate',document.getElementById('adress'),'选择标签参数(终极类)',700,420);" class="list_link" title="包括新闻终极、专题终极">终极类</a> &nbsp;  
      <a href="javascript:show('Browse',document.getElementById('adress'),'选择标签参数(浏览类)',700,420);" class="list_link" >浏览类</a> &nbsp;  
      <a href="javascript:show('ClassInfo',document.getElementById('adress'),'选择标签参数(栏目信息类)',700,420);" class="list_link" >栏目信息类</a>&nbsp;&nbsp;&nbsp;
      <a href="javascript:show('Routine',document.getElementById('adress'),'选择标签参数(常规类/高级扩展)',700,430);" class="list_link" title="包括SUB子类、不规则新闻、位置导航、搜索、统计、幻灯片、站点地图、图片头条、相关新闻、归档、总站导航、栏目导航、专题导航、RSS、栏目调用、调用栏目信息(关键字、meta)、自定义页面、新闻排行、评论排行">常规&扩展类</a> &nbsp;  
      ...
      <a href="javascript:show('Other',document.getElementById('adress'),'选择标签参数(其他类)',700,300);" class="list_link" title="包括自由JS、系统JS、广告JS、统计JS、其他JS、友情连接">其他类</a> &nbsp;  
      <a style="display:none;" href="javascript:show('API',document.getElementById('adress'),'选择标签参数(API类)',700,340);" class="list_link">API类</a></td>
    </tr>    
    <tr class="TR_BG_list">
      <td align="center" class="navi_link" style="width: 13%">标签内容</td>
      <td Width="90%" align="left" ><!--编辑器开始-->
...
//            }
		...
		<textarea rows="15" cols="120" name="ContentTextBox" id="ContentTextBox" runat="server" ></textarea>
      </td>
    </tr>
    ...
    <tr class="TR_BG_list">
      ...
      <td Width="90%" align="left">
          <asp:TextBox ID="LabelDescription" runat="server" Height="50px" TextMode="MultiLine" Width="400px" MaxLength="200"></asp:TextBox><span class="helpstyle" style="cursor:help;" title="点击显示帮助" onclick="Help('H_Labeladd_003',this)">帮助</span></td>
    </tr>
    <tr class="TR_BG_list">
...
{
    var oEditor = document.getElementById("ContentTextBox");
