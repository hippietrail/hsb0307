...
<body>
  ...
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
    ...
    <tr class="TR_BG_list">
      ...
      <td  style="width:90%" align="left" >
      <!--编辑器开始编辑器结束-->
         <asp:TextBox ID="FileContent" runat="server" Width="90%" Height="200px" TextMode="MultiLine"></asp:TextBox><div id="test" runat="server"></div>
       <!--<script type="text/javascript" language="JavaScript">
        window.onload = function()
	        {
	        var sBasePath = "../../editor/"
            var oFCKeditor = new FCKeditor('FilesContent') ;
		...
		<textarea rows="1" cols="1" name="FilesContent" style="display:none" id="FilesContent" runat="server" ></textarea>
      -->
      </td>
    </tr>
    <tr class="TR_BG_list">
