<%@ Page Language="C#" AutoEventWireup="true" Inherits="manage_advertisement_Ads_add" ResponseEncoding="utf-8" Codebehind="ads_add.aspx.cs" %>
...
<form id="AdsForm" runat="server" method="post" action="">
  <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="toptable">
    <tr>
      ...
      <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="list.aspx" target="sys_main" class="list_link">广告系统</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />添加广告</div></td>
    </tr>
  </table>
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
    ...
    <tr class="TR_BG_list" id="TrCycID" style="display:none;">
     ...
     </asp:DropDownList><input type="hidden" id="CycTF" value="0" />
    ...
    <tr class="TR_BG_list">
      <td align="center" class="navi_link">显示条件</td>
      <td align="left"><asp:RadioButtonList ID="CondiTF" runat="server" RepeatDirection="Horizontal">
    ...
    <tr class="TR_BG_list">
      <td align="center" class="navi_link">是否锁定</td>
      <td align="left"><asp:RadioButtonList ID="isLock" runat="server" RepeatDirection="Horizontal">
...
function checkData(value)
{
    ...
    document.AdsForm.action="Ads_add.aspx?Type=Add&CycTF="+document.AdsForm.CycTF.value;
