...
namespace Hg.AccessDAL
{
    public class UserMisc : DbBase, IUserMisc
    {
        ...
        public DataTable calendar(string UserNum)
        {
            ...
            string Sql = "Select id,logID,Title,Content,userNum,LogDateTime From " + Pre + "user_userlogs Where (DATEDIFF('d', LogDateTime, Now())<=datenum) and Usernum=@UserNum and SiteID='" + Hg.Global.Current.SiteID + "'";
...
new OleDbParameter("@UserNum", UserNum)
            ...
            string getS = "";
            string SQLTF = "select am_ID from " + Pre + "api_Navi where am_ParentID=@stype and siteID='" + Hg.Global.Current.SiteID + "' ";
        ...
        {
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys From " + Pre + "API_Navi where Am_position='00000' and SiteID='" + Hg.Global.Current.SiteID + "' order by am_orderID desc,am_id asc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        /// <summary>
        ...
        public DataTable ManagechildmenuNavilist(string pID)
        {
            ...
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys From " + Pre + "API_Navi where am_ParentID=@pID and SiteID='" + Hg.Global.Current.SiteID + "' order by am_orderID desc,am_id asc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        public DataTable getManageChildNaviRecord(string am_ClassID)
        {
            ...
            string Sql = "Select am_ClassID From " + Pre + "API_Navi Where am_ClassID=@am_ClassID and SiteID='" + Hg.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        public DataTable GetNaviEditID(int nID)
        {
            ...
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys,popCode From " + Pre + "API_Navi where am_id=@nID and SiteID='" + Hg.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        ...
        {
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys,popCode From " + Pre + "API_Navi where Am_position='00000' and SiteID='" + Hg.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        {
            OleDbParameter param = new OleDbParameter("@pID", pID);
            string Sql = "Select am_id,api_IdentID,am_ClassID,Am_position,am_Name,Am_Ename,am_FilePath,am_target,am_ParentID,am_type,am_orderID,isSys,popCode From " + Pre + "API_Navi where am_ParentID=@pID and SiteID='" + Hg.Global.Current.SiteID + "' order by am_orderID desc,am_id desc";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, param);
            return rdr;
        }
        /// <summary>
        ...
        /// <returns></returns>
        private OleDbParameter[] InsertManageMenuParameters(Hg.Model.UserInfo7 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertManageMenuParameters1(Hg.Model.UserInfo7 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertManageMenuParameters2(Hg.Model.UserInfo7 uc1)
        {
        ...
        {
            string Sql = "Select id,QMID,qName,FilePath,usernum,siteid,orderid From " + Pre + "API_Qmenu where (UserNum='" + Hg.Global.Current.UserNum + "' or UserNum='0') and ismanage=" + _num + " and SiteID='" + Hg.Global.Current.SiteID + "' order by OrderID desc,id desc";
            return DbHelper.ExecuteReader(CommandType.Text, Sql, null);
        }
        ...
        {
            string Sql = "Select QmID,qName,FilePath,Ismanage,OrderID,usernum,siteID From " + Pre + "API_Qmenu Where ID=" + QID + " and UserNum = '" + Hg.Global.Current.UserNum + "' and SiteID='" + Hg.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        /// <summary>
        ...
        {
            string Sql = "Select QmID From " + Pre + "API_Qmenu Where UserNum='" + Hg.Global.Current.UserNum + "' and ismanage=" + num + " and SiteID='" + Hg.Global.Current.SiteID + "'";
            DataTable rdr = DbHelper.ExecuteTable(CommandType.Text, Sql, null);
            return rdr;
        }
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertQMenuParameters(Hg.Model.UserInfo8 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertQMenuParameters1(Hg.Model.UserInfo8 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[4];
        ...
        /// <param name="uc"></param>
        /// <returns></returns>
        private OleDbParameter[] GetUserInfoParameters(Hg.Model.UserInfo uc)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] GetUserInfoParameters1(Hg.Model.UserInfo1 uc1)
        {
        ...
        private OleDbParameter[] GetUserInfoContactParameters1(Hg.Model.UserInfo2 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[10];
        ...
        private OleDbParameter[] GetUserInfoBaseStatParameters1(Hg.Model.UserInfo3 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] InsertGroupParameters(Hg.Model.UserInfo4 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] updateGroupEditParameters(Hg.Model.UserInfo4 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] GetAnnounceParameters(Hg.Model.UserInfo5 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[9];
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateAnnounceParameters(Hg.Model.UserInfo5 uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] insertCardRParameters(Hg.Model.IDCARD uc1)
        {
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateCardRParameters(Hg.Model.IDCARD uc1)
        {
            OleDbParameter[] param = new OleDbParameter[8];
        ...
        public void UpdateOnlinePay(Hg.Model.UserInfo6 uc2)
        {
            ...
            if (dt != null)
            {
                if (dt.Rows.Count > 0)
                {
                    Sql = "Update " + Pre + "sys_PramUser set onpayType=" + uc2.onpayType + ",O_userName='" + uc2.O_userName + "',o_key='" + uc2.O_key + "',O_sendurl='" + uc2.O_sendurl + "',O_returnurl='" + uc2.O_returnurl + "',O_md5='" + uc2.O_md5 + "',O_other1='" + uc2.O_other1 + "',O_other2='" + uc2.O_other2 + "',O_other3='" + uc2.O_other3 + "' where SiteID='" + Hg.Global.Current.SiteID + "'";
                }
                else
                {
                    Sql = "Insert Into " + Pre + "sys_PramUser(onpayType,O_userName,o_key,O_sendurl,O_returnurl,O_md5,O_other1,O_other2,O_other3,SiteID) Values(" + uc2.onpayType + ",'" + uc2.O_userName + "','" + uc2.O_key + "','" + uc2.O_sendurl + "','" + uc2.O_returnurl + "','" + uc2.O_md5 + "','" + uc2.O_other1 + "','" + uc2.O_other2 + "','" + uc2.O_other3 + "','" + Hg.Global.Current.SiteID + "')";
                }
            }
        ...
        /// <param name="uc1"></param>
        /// <returns></returns>
        private OleDbParameter[] UpdateOnlinePayParameters(Hg.Model.UserInfo6 uc1)
        {
            OleDbParameter[] param = new OleDbParameter[9];
