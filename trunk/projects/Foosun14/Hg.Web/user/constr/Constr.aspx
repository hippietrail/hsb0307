<%@ Page Language="C#" ContentType="text/html" AutoEventWireup="true" Inherits="user_Constr" Debug="true" Codebehind="Constr.aspx.cs" %>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
  ...
  <tr class="TR_BG_list">
    <td class="list_link" style="text-align: right; width: 110px;">
        ...
        <br />
        <br />
        <a href="javascript:;" onclick="selectFile('user_Edit',document.getElementById('picContentTF'),320,500);">上传图片</a>
        </td>
   ...
   <tr class="TR_BG_list" >
    <td class="list_link" style="text-align: right; width: 110px;">频道分类：</td>
       <td class="list_link" colspan="5">
        &nbsp;<asp:DropDownList ID="site" runat="server" Width="147px" CssClass="form"></asp:DropDownList>
   ...
   <tr class="TR_BG_list">
    <td class="list_link" style="height: 32px; text-align: right; width: 110px;">图 片：</td>
       <td class="list_link" colspan="5">
         ...
         <input  class="form" type="button" value="选择图片"  onclick="selectFile('user_pic',document.form1.photo,300,520);document.form1.photo.focus();" /><span class="helpstyle" style="cursor:help;" title="点击查看帮助" onClick="Help('H_Constr_0011',this)">帮助</span> 
       </td>
  </tr>
   <tr class="TR_BG_list">
