...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          ...
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">�λ�õ�����<a href="../main.aspx" target="sys_main" class="list_link">��ҳ</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="Constrlist.aspx" class="menulist">���¹��</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />��˺Ź��</div>
          </td>
        </tr>
</table>
      <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
        <tr>
          ...
          <a href="Constr.aspx" class="menulist">��������</a>&nbsp; &nbsp;<a href="Constrlistpass.aspx" class="topnavichar" >������˸</a>&nbsp; &nbsp;<a href="Constrlist.aspx" class="menulist">����¹��</a>&nbsp; &nbsp;<a href="ConstrClass.aspx" class="menulist">������</a>&nbsp; &nbsp;<a href="Constraccount.aspx" class="menulist">��˺Ź��</a>&nbsp; &nbsp;<a href="Constraccount_add.aspx" class="menulist">�����˺</a>
          </td>
...
<div id="no" runat="server"></div>
    ...
    <tr class="TR_BG">
    <td class="sys_topBg" align="center" width="15%">ſ����</td>
    <td class="sys_topBg" align="center" width="25%">����</td>
    <td class="sys_topBg" align="center" width="25%">������˺</td>
    <td class="sys_topBg" align="center" width="15%">ſ��</td>
    <td class="sys_topBg" align="center" width="20%">Ų��</td>
    </tr>
