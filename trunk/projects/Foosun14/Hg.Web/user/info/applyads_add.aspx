...
<form id="AdsForm" runat="server"  method="post" action="">
    ...
    <tr>
      ...
      <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="applyads.aspx" class="list_link">申请广告</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />添加广告</div></td>
    </tr>
    </table>
  <table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">
    ...
    <tr class="TR_BG_list" id="TrleftPic">
      ...
      <td colspan="2" align="left"><asp:TextBox ID="leftPic" runat="server" Width="250px" MaxLength="200" CssClass="form"></asp:TextBox> <img src="../../sysImages/folder/s.gif" style="cursor:pointer;" title="选择图片"  onclick="selectFile('user_pic',document.AdsForm.leftPic,280,500);document.AdsForm.leftPic.focus();" />
    ...
    <tr class="TR_BG_list" style="display:none;" id="TrrightPic">
      ...
      <td colspan="2" align="left"><asp:TextBox ID="rightPic" runat="server" Width="250px" MaxLength="200" CssClass="form"></asp:TextBox> <img src="../../sysImages/folder/s.gif" style="cursor:pointer;" title="选择图片"  onclick="selectFile('user_pic',document.AdsForm.rightPic,280,500);document.AdsForm.rightPic.focus();" />
