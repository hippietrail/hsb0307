...
<title><%Response.Write(Hg.Config.UIConfig.HeadTitle); %>__注册结束</title>
...
<div style="width:100%" id="topshow">
    ...
    <tr>
        <td style="width:30%;"><%--<a href="http://www.hg.net" target="_blank"><img src="../sysImages/user/userlogo.gif" border="0" /></a>--%></td>
