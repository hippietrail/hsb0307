...
<div id="no" runat="server"></div>
  <asp:Repeater ID="Repeater2" runat="server" >
    ...
    <tr class="TR_BG">
    <td class="sys_topBg" width="60%">活动名称</td>
    <td class="sys_topBg" width="15%">创建时间</td>
    <td class="sys_topBg" width="20%">操作&nbsp; &nbsp;<input type="checkbox" name="Checkbox1" onclick="javascript:selectAll(this.form,this.checked)" /></td>
    </tr>
    <div id="tnzlist" runat="server"></div>
    </HeaderTemplate>
    <ItemTemplate>
        <tr class="TR_BG_list" onmouseover="overColor(this)" onmouseout="outColor(this)">
        <td width="60%"><%#((DataRowView)Container.DataItem)[2]%>(<%#((DataRowView)Container.DataItem)[5]%>)</td>
        <td width="15%"><%#((DataRowView)Container.DataItem)[4]%></td>
        <td width="20%"><%#((DataRowView)Container.DataItem)[6]%></td>           
        </tr>
     </ItemTemplate>
     <FooterTemplate>
     </table>
