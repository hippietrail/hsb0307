...
<div id="no" runat="server"></div>
  <asp:Repeater ID="DataList1" runat="server" >
    ...
    <tr class="TR_BG">
<td class="sys_topBg" align="center" width="50%">活动名称</td>
    <td class="sys_topBg" align="center" width="15%">建立人</td>
    <td class="sys_topBg" align="center" width="15%">创建时间</td>
    <td class="sys_topBg" align="center" width="5%">参加人数</td>
    <td class="sys_topBg" align="center" width="15%">操作</td>
    </tr>
    <div id="tnzlist" runat="server"></div>
    </HeaderTemplate>
    <ItemTemplate>
        <tr class="TR_BG_list" onmouseover="overColor(this)" onmouseout="outColor(this)">
        <td align="left" width="50%"><%#((DataRowView)Container.DataItem)[2]%></td>
        <td align="left" width="15%"><%#((DataRowView)Container.DataItem)[3]%></td>
