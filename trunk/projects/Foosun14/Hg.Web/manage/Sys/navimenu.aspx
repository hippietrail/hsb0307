<%@ Page Language="C#" AutoEventWireup="true" Inherits="manage_System_navimenu"  ResponseEncoding="utf-8" Codebehind="navimenu.aspx.cs" %>
...
<table width="100%" height="32" align="center" border="0" cellpadding="0" cellspacing="0" background="../../sysImages/<% Response.Write(Hg.Config.UIConfig.CssPath()); %>/admin/reght_1_bg_1.gif">
      ...
      <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
        ...
        <tr class="TR_BG_list">
          ...
          <td class="list_link"><input name="position" style="width:250px" maxlength="5" value="99999">
        ...
        <tr class="TR_BG_list">
          ...
          <td class="list_link">
          <asp:TextBox ID="orderID" runat="server" Text="10" Width="100" />
        ...
        <tr class="TR_BG_list">
          ...
          <td class="list_link" style="height: 28px">&nbsp;<asp:Button ID="sumbitsave" runat="server" CssClass="form" Text=" 确 定 " OnClick="Navisubmit" />
