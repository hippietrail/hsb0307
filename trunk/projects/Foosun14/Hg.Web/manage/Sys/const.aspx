...
<table width="98%" border="0" cellspacing="1" cellpadding="5" class="table" bgcolor="#FFFFFF" align="center">
  ...
  <tr class="TR_BG_list">
    ...
    <td align="left" valign="middle">&nbsp;<asp:TextBox ID="protPass" Width="200px" runat="server" CssClass="form"></asp:TextBox><span class="helpstyle" style="cursor:hand;" title="点击查看帮助" onClick="Help('H_const_Pass',this)">帮助</span></td>
    </tr>
  <tr class ="TR_BG_list">
