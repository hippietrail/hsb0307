...
<body>
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="0" background="../sysImages/Login/top_bg.gif">
		<tr>
			<td style="height: 55px; width: 10%;">
			</td>
			<td style="height: 55px; width: 40%;">
				&nbsp;
			</td>
			<td style="height: 55px; width: 50%; padding-right: 10px;">
				<div align="right">
					<a href="http://www.foosun.net" target="_blank" class="JH">官方站</a>&nbsp;┊&nbsp; <a href="http://bbs.foosun.net">技术论坛</a>&nbsp;┊&nbsp;<a href="http://www.newsCMS.com">NewsCMS</a>&nbsp;┊&nbsp;<a href="http://www.NewsIDC.com" title="专用虚拟主机" target="_blank">资讯数据(IDC)</a>&nbsp;┊&nbsp;<a href="http://help.foosun.net" target="_blank">在线帮助</a>&nbsp;┊&nbsp;<a href="http://doc.foosun.net" target="_blank">开发者中心</a></div>
			</td>
		</tr>
	</table>
	<table style="width: 100%;" border="0" cellpadding="0" cellspacing="10">
		<tr>
			<td style="width: 74px; height: 60px;" colspan="3">
				&nbsp;
			</td>
		</tr>
		<tr>
			<td style="width: 442px;" valign="top">
				<div align="right">
					<table style="width: 100%;" border="0" cellpadding="5" cellspacing="3">
						<tr>
							<td>
								<div align="right">
									<img src="../sysImages/Login/Logo.gif" width="194" height="44" /></div>
							</td>
						</tr>
						<tr>
							<td>
						...
						<tr>
							<td>
								<div align="right">
									<a href="#"><font color="#666666">在线客服</font></a></div>
							</td>
						</tr>
					</table>
				</div>
			</td>
			<td style="width: 1px;" bgcolor="#CCCCCC">
			</td>
				...
				<table style="width: 100%;" border="0" cellpadding="5" cellspacing="3">
					...
					<tr>
						<td colspan="2" style="height: 21px">
							<div align="left">
								密 码
								<asp:TextBox ID="TxtPassword" CssClass="password" Width="129px" runat="server" TextMode="Password"></asp:TextBox></div>
						</td>
					</tr>
					...
					<tr>
						...
						<td width="65%">
							<a href="Register.aspx?SiteID=<%Response.Write(SiteID); %>">免费注册</a>&nbsp;&nbsp;&nbsp;<a href="info/getPassword.aspx">忘记密码？</a>
						</td>
					</tr>
				</table>
			</td>
