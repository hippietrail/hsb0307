    ...
    <form id="ListLabel" runat="server">
        ...
        function savePostStyle()
        {
         ...
         <tr class="TR_BG_list" id="TrulID" style="display:none;">
          ...
          <tr class="TR_BG_list">
            <td align="right" class="navi_link" style="width:105px">分页链接样式</td>
            <td align="left" class="navi_link">
             当前页链接CSS：<asp:TextBox ID="Current_txt_style" Width="50" CssClass="form" runat="server"></asp:TextBox>&nbsp;其它页链接CSS：<asp:TextBox ID="Other_txt_style" CssClass="form" Width="50" runat="server"></asp:TextBox>
            </td>
          </tr>
          <tr class="TR_BG_list">
