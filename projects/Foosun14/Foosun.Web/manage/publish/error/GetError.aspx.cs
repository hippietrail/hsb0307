...
public partial class manage_publish_error_GetError : Hg.Web.UI.ManagePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
                                                 //判断用户是否登录
            filename = "../../../logs/public/" + Hg.Config.UIConfig.Logfilename + "_" + DateTime.Now.Month + DateTime.Now.Day + ".log";
