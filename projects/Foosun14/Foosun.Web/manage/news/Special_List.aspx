...
<form id="form1" runat="server"> 
  ...
  <tr>
    ...
    <tr>
        <td colspan="2" style="padding-left: 15px">搜索专题名称：<asp:TextBox ID="search_SpecialCName" runat="server"></asp:TextBox><asp:Button ID="search_button"
        runat="server" Text="查询" OnClick="search_button_Click" />
        </td>
    </tr>   
