...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
  <tr>
     <td><span class="topnavichar" style="PADDING-LEFT: 14px"><a href="Photoalbumlist.aspx" class="menulist">�����ҳ</a>&nbsp;��&nbsp;<a href="photo_add.aspx" class="menulist">���ͼƬ</a>&nbsp;��&nbsp;<a href="photoclass.aspx" class="menulist">�����</a>&nbsp;੮&nbsp;<a href="Photoalbum.aspx" class="menulist">�����</a></span></td>
  </tr>
</table>
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table" id="insert">
  ...
  <tr class="TR_BG_list">
    ...
    <td class="list_link" style="width: 707px">
        <asp:TextBox ID="PhotoName" runat="server" Width="350px" CssClass="form"></asp:TextBox>&nbsp;��᣺<asp:DropDownList ID="Photoalbum" runat="server" Width="133px">
        </asp:DropDownList></td>
  </tr>
  ...
  <tr class="TR_BG_list">
    ...
    <table width="81%" border="0" cellspacing="1" cellpadding="1">
               ...
               <td align="center" style="width: 162px" style="display:none;">
                ...
                <tr> 
                  <td class="list_link" style="width: 176px"><div align="center"><input  class="form" type="button" value="� ϴ�"  onclick="selectFile('user_pic',
document.form1.pic_p_1url,300,500);" />&nbsp;&nbsp;<input id="Button2" type="button" value="ɾ �" class="form" onClick="dels_1();"/>
                    </div></td>
                  <td class="list_link" style="display:none;" ><div align="center"><input  class="form" type="button" value="�� ϴ�"  onclick="selectFile('user_pic',document.form1.pic_p_1ur2,300,500);" />&nbsp;&nbsp;<input id="Button3" type="button" value="ɾ �" class="form" onClick="dels_2();"/>
                    </div></td>
                  <td class="list_link"  style="display:none;" ><div align="center"><input  class="form" type="button" value="�� ϴ�"  onclick="selectFile('user_pic',document.form1.pic_p_1ur3,300,500);" /> &nbsp;&nbsp;<input id="Button4" type="button" value="ɾ �"  class="form" onClick="dels_3();"/>
                    </div></td>
                </tr>
              </table>
    </td>
    ...
    <td class="list_link" style="width: 707px">
        <asp:Button ID="server" runat="server" Text="���浽��" Width="115px" OnClick="server_Click" CssClass="form"/></td>
        </tr>
