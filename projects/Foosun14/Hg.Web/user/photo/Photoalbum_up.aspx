...
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
  <tr>
     <td><span class="topnavichar" style="PADDING-LEFT: 14px"><a href="Photoalbumlist.aspx" class="menulist">������ҳ</a>
         ...
         <a href="photoclass.aspx" class="menulist">�����</a>&nbsp;੮&nbsp;<a href="Photoalbum.aspx" class="menulist">�����</a>&nbsp;ᩮ&nbsp;<a href="javascript:upMaterial()" class="list_link">�޸�������</a>&nbsp;ϩ�&nbsp;<span id="uppwd" runat="server"></span></span></td>
  </tr>
</table>
