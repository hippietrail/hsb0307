...
public partial class user_UserLoginajax : Hg.Web.UI.BasePage
{
    ...
    protected string UserLoginTrue()
    {
        ...
        if (styleContent != null && styleContent!="")
        {
            try
            {
                ...
                User_Name = Hg.Global.Current.UserName;
                guanli = "<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">会员中心</a>";
                guanliAdr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx";
                if (str_LoginP != "true")
                {
                    guanli = "<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">管理</a>";
                    guanliAdr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx";
                }
                ziliao = "<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
                ziliaoAdr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/userinfo.aspx";
                taolunzu = "<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
                taolunzuAdr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx";
        ...
        if (str_LoginP == "true")
        {
            ...
            str_UserLogin += "       欢迎 <span style=\"font-weight:bold;\">" + Hg.Global.Current.UserName + "</span> 再次登录！";
            str_UserLogin += "       <a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">会员中心</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/message/Message_box.aspx?Id=1\" target=\"_blank\">消息</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
        ...
        else
        {
            ...
            str_UserLogin += "   </div>" + newLine;
            str_UserLogin += "   <div style=\"text-align:center;\">" + newLine;
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Index.aspx\" target=\"_blank\">管理</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/userinfo.aspx\" target=\"_blank\">资料</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/message/Message_box.aspx?Id=1\" target=\"_blank\">消息</a>";
            str_UserLogin += "       &nbsp;<a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/index.aspx?urls=" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/discuss/discussManageestablish_list.aspx\" target=\"_blank\">讨论组</a>";
            str_UserLogin += "       &nbsp;<a href=\"javascript:LoginOut();\">退出</a>";
    ...
    protected void UserLoginForm()
    {
        ...
        {
            RegstrCss = Hg.Common.Input.URLDecode(str_RegCSS);
        }
        string Passstr = "忘记密码";
        string PassstrCss = "";
        if (str_PassCSS != string.Empty && str_PassCSS != null)
        {
            PassstrCss = Hg.Common.Input.URLDecode(str_PassCSS);
        }
        ...
        if (styleContent != "")
        {
            try
            {
                ...
                RegLinkStr = "<span class=\""+RegstrCss+"\"><a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Register.aspx\" title=\"注册新用户\">" + Regstr + "</a></span>";
                GetPassStr = "<span class=\"" + PassstrCss + "\"><a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/getPassword.aspx\" title=\"找回密码\">" + Passstr + "</a></span>"; ;
                RegLinkAdrStr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Register.aspx";
                GetPassAdrStr = Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/getPassword.aspx";
        ...
        else
        {
            ...
            if (str_LoginCSS != string.Empty && str_LoginCSS != null)
            {
                if (str_LoginCSS.IndexOf(".") > -1)
                {
                    ...
                    {
                        imgsrc = Hg.Publish.CommonData.getUrl() + "/" + str_LoginCSS;
                    }
            ...
            if (str_LoginP == "true")
            {
                ...
                str_UserLogin += "       <a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/getPassword.aspx\">" + Passstr + "</a>&nbsp;&nbsp;";
                str_UserLogin += "       <a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Register.aspx\">" + Regstr + "</a>";
            }
            else
            {
                str_UserLogin += "   <div>" + newLine;
                str_UserLogin += "       帐号：<input name=\"UserNum\" " + formCSS + " type=\"text\" size=\"10\" maxlength=\"20\" /> " + formlogin + " <span class=\"" + RegstrCss + "\"><a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/info/getPassword.aspx\">" + Passstr + "</a></span>";
                str_UserLogin += "   </div>" + newLine;
                str_UserLogin += "   <div>" + newLine;
                str_UserLogin += "       密码：<input name=\"UserPwd\" " + formCSS + " type=\"password\" id=\"UserPwd\" size=\"10\" /> " + resetlogin + " <span class=\"" + PassstrCss + "\"><a href=\"" + Hg.Publish.CommonData.getUrl() + "/" + Hg.Config.UIConfig.dirUser + "/Register.aspx\">" + Regstr + "</a></span>";
                str_UserLogin += "   </div>" + newLine;
            }
            str_UserLogin += "</form>" + newLine;
