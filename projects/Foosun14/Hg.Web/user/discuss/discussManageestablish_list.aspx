...
<div id="no" runat="server"></div>
  <asp:Repeater ID="Repeater2" runat="server" >
    ...
    <tr class="TR_BG">
    <td class="sys_topBg" width="60%">讨论组(加入人数)&nbsp;[点击]</td>
    <td class="sys_topBg">创建时间</td>
    <td class="sys_topBg">操作&nbsp; &nbsp;<input type="checkbox" name="Checkbox1" onclick="javascript:selectAll(this.form,this.checked)" /></td>
    </tr>
    </HeaderTemplate>
    <ItemTemplate>
        <tr class="TR_BG_list" onmouseover="overColor(this)" onmouseout="outColor(this)">
        <td width="60%"><%#((DataRowView)Container.DataItem)["titles"]%>(<%#((DataRowView)Container.DataItem)["cutDisID2"]%>)&nbsp;[<%#((DataRowView)Container.DataItem)["Browsenumber"]%>]</td>
        <td><%#((DataRowView)Container.DataItem)["Creatime"]%></td>
        <td><%#((DataRowView)Container.DataItem)["idc2"]%></td>           
        </tr>
     </ItemTemplate>
     <FooterTemplate>
     </table>
