...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          <td width="57%"  class="sysmain_navi"  style="PADDING-LEFT: 14px" >
              文章管理</td>
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="Constrlist.aspx" class="menulist">文章管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />稿酬记录</div></td>
        </tr>
</table>
...
<div>
    ...
    <tr class="TR_BG">
    <td class="sys_topBg" align="center" width="15%">稿酬编号</td>
    <td class="sys_topBg" align="center" width="15%">稿酬数目</td>
    <td class="sys_topBg" align="center" width="15%">支付时间</td>
    </tr>
