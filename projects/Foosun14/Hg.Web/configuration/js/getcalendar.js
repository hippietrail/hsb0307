...
function TWebCalendar() //初始化日历的设置
{
    ...
    this.darkColor  = "#94C6E1";    //控件的暗色
    this.lightColor = "#FFFFFF";    //控件的亮色
    this.btnBgColor = "#EFF8FB";    //控件的按钮背景色
    this.wordColor  = "#090A0A";    //控件的文字颜色
    this.wordDark   = "#7E938C";    //控件的暗文字颜色
    this.dayBgColor = "#FDFEFE";    //日期数字背景色
    this.todayColor = "#808080";    //今天在日历上的标示背景色
