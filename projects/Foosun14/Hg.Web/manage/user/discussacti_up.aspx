<%@ Page Language="C#" ContentType="text/html" ResponseEncoding="utf-8" AutoEventWireup="true" Inherits="manage_discussacti_up" EnableEventValidation="true" Codebehind="discussacti_up.aspx.cs" %>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          ...
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="discussacti_list.aspx" class="menulist">讨论活动管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />修改活动</div></td>
        </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table">  
  ...
  <tr class="TR_BG_list">
    ...
    <td class="list_link">
        <asp:TextBox ID="ActivePlanBox" runat="server" TextMode="MultiLine" Height="76px" Width="348px"></asp:TextBox>&nbsp;
