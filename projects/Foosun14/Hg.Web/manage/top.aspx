        ...
        <div>
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="0" class="indexq">
                            <tr>
                                ...
                                <td align="right">
                                    ...
                                    <a href="http://www.hg.net" target="sys_main" class="Lion_1" title="华光官方站">Hg.NET</a>&nbsp;&nbsp;
                                </td>
                            </tr>
                        </table>
                    </td>
                ...
                <td>
                    ...
                    <tr>
                    <td class="button_down" onclick="javascript:ChangeMenu(0);" style="cursor:pointer; " width=99>隐藏菜单</td>
                    <td>
                        <%--<div id="navi_index" runat="server" />--%>
                        <asp:Literal ID="navi_index" runat="server"></asp:Literal>
