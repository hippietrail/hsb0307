<%@ Page Language="C#" AutoEventWireup="true" Inherits="manage_System_shortcut" Codebehind="shortcut.aspx.cs" %>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="toptable">
      ...
      <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
        <form id="form1" runat="server"><tr class="TR_BG_list">
          ...
          <td class="list_link"><asp:TextBox ID="qName" runat="server"  Width="250"  MaxLength="50"></asp:TextBox>
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onClick="Help('H_shortcut_0001',this)">帮助</span><asp:RequiredFieldValidator ID="f_qName" runat="server" ControlToValidate="qName" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)请填写快捷菜单名称，长度为50字节</span>"></asp:RequiredFieldValidator>
          </td>
        </tr>                                                                                                                                                                                                                                                                                             
        <tr class="TR_BG_list">
          ...
          <span class="helpstyle" style="cursor:help;"  title="点击查看帮助" onClick="Help('H_shortcut_0002',this)">帮助</span><asp:RequiredFieldValidator ID="f_FilePath" runat="server" ControlToValidate="FilePath" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)请填写快捷菜单连接路径，长度为200字节</span>"></asp:RequiredFieldValidator></td>
        </tr>
        <tr class="TR_BG_list">
        ...
        <tr class="TR_BG_list">
          <td class="list_link" style="width: 114px; height: 28px;">&nbsp;</td>
          <td class="list_link" style="height: 28px">如何使用快捷方式？查看<span class="helpstyle" style="cursor:help"  onclick="Help('H_shortcut_0004',this)">帮助</span></td>
        </tr>
</form>
</table>
<br />
