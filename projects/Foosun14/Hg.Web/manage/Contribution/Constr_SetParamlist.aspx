...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          <td width="57%"  class="sysmain_navi"  style="PADDING-LEFT: 14px" >
              ������</td>
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">�λ�õ�����<a href="../main.aspx" target="sys_main" class="list_link">��ҳ</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="Constr_List.aspx" target="sys_main" class="list_link">�����</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />������</div></td>
        </tr>
</table>
<table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
  <tr>
    <td width="46%" class="navi_link">&nbsp; &nbsp; &nbsp;<a href="Constr_List.aspx" class="topnavichar">ø����</a>&nbsp; &nbsp;<a href="#" class="topnavichar">��������</a>&nbsp; &nbsp;<a href="Constr_SetParam.aspx" class="topnavichar">�������</a>&nbsp; &nbsp;<span id="pdels" runat="server"></span></td>
  </tr>
</table>
...
<div>
    ...
    <tr class="TR_BG">
    <td class="sys_topBg" align="center" width="17.5%">õȼ���</td>
    <td class="sys_topBg" align="center" width="17.5%">Ƹ�</td>
    <td class="sys_topBg" align="center" width="17.5%">����</td>
    <td class="sys_topBg" align="center" width="17.5%">����</td>
    <td class="sys_topBg" align="center" width="17.5%">�λ</td>
    <td class="sys_topBg" align="center" width="17.5%">���&nbsp; &nbsp;<input type="checkbox" name="Checkbox1" onclick="javascript:selectAll(this.form,this.checked)" /></td>
    </tr>
