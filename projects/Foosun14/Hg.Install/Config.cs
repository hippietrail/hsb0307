...
namespace Hg.Install
{
	public class Config
	{
		...
		static Config()
		{
			...
			regprotocol = "<p>版权所有 (c) 2002-2010，潍坊北大青鸟华光照排有限公司<br />保留所有权利。" +
						  "<p>感谢您选择 Hg WebFastCMS 产品。希望我们的努力能为您提供一个高效快速和功能强大的大型门户网站解决方案。" +
						  "<p>WebFastCMS 是 Hg 基于微软最新的Web开发技术ASP.NET的新一代网站内容管理系统，以下简称WebFastCMS。" +
                          "<p>潍坊北大青鸟华光照排有限公司 Hg WebFastCMS 产品的开发商，依法独立拥有 WebFastCMS 产品著作权（中国国家版权局" +
						  "著作权登记号 2008SR12575）。公司网址为 http://www.hg.net，WebFastCMS 官方站为 http://www.hg.net，WebFastCMS 官方讨论区为 http://bbs.hg.net。" +
						  "<p>WebFastCMS 著作权已在中华人民共和国国家版权局注册，著作权受到法律和国际公约保护。使用者：无论个人或组织、盈利" +
						  "与否、用途如何（包括以学习和研究为目的），均需仔细阅读本协议，在理解、同意、并遵守本协议的全部条款后，" +
                          "方可开始使用 WebFastCMS 软件。<p>本授权协议适用且仅适用于 WebFastCMS 1.x 版本，潍坊北大青鸟华光照排有限" +
						  ...
						  "oosun.net参考相关说明，也可以致电(+86)0536-2991100/601了解详情。<li>不得对本软件或与之关联的商业授权进行" +
						  "出租、出售、抵押或发放子许可证。<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，" +
						  "只要使用 WebFastCMS 的整体或任何部分，未经书面许可，网站" +
                          "页面内的 Hg、HgCMS、WebFastCMS和潍坊北大青鸟华光照排有限公司下属网站（http://www." +
						  "hg.net、http://www.hg.com、http://www.hg.com） 的链接都必须保留，而" +
						  "不能清除或修改。<li>禁止在 WebFastCMS 的整体或任何部分基础上以发展任何派生版本、修改" +
                          ...
                          "潍坊北大青鸟华光照排有限公司不对使用本软件构建的网站中的文章或信息承担责任。</ul></ul><p>有关 WebFastCMS " +
                          "最终用户授权协议、商业授权与技术服务的详细内容，均由 WebFastCMS 官方网站独家提供。潍坊北大青鸟华光照排" +
		...
		public static string InitialSystemValidCheck(ref bool error)
		{
			...
			//检查系统目录的有效性
			string folderstr = "comm,configuration,controls,database,editor,files,Install,jsfiles,logs," + manageForderName + "," +
