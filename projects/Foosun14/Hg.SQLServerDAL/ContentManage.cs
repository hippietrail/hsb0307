...
namespace Hg.SQLServerDAL
{
	public class ContentManage : DbBase, IContentManage
	{
		...
		private SqlParameter[] insertClassContentParameters(Hg.Model.ClassContent uc)
		{
			...
			param[36] = new SqlParameter("@isRecyle", SqlDbType.TinyInt, 1);
			param[36].Value = uc.isRecyle;
			param[37] = new SqlParameter("@NaviPosition", SqlDbType.NText, 1024);
			param[37].Value = uc.NaviPosition;
			param[38] = new SqlParameter("@NewsPosition", SqlDbType.NText, 1024);
        ...
        public DataTable GetPage(string SpecialID, string Editor, string ClassID, DateTime? startDate, DateTime? endDate, string sKeywrd, string DdlKwdType, string sChooses, string SiteID, int PageIndex, int PageSize, out int RecordCount, out int PageCount, params SQLConditionInfo[] SqlCondition)
		{
            ...
            string AllFields = "a.Id,a.NewsID,a.NewsType,a.TitleColor,a.TitleITF,a.TitleBTF,a.Author,a.DataLib,a.OrderID,a.NewsTitle,a.NewsTitleRefer,a.ishtml,a.Editor,a.Click,a.isConstr,a.ClassID,a.isLock,a.NewsProperty,a.CheckStat,a.URLaddress,a.Tags,b.UserName,c.ClassCName";
