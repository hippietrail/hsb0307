...
if ( n < 10){n = "0" + n;} 
outObject.value= yy + "-" + ('00'+mm).substr(('00'+mm).length - 2,2) + "-" + ('00'+n).substr(('00'+n).length - 2,2) ; //注：在这里你可以输出改成你想要的格式 
outObject.realValue= yy + "-" + ('00'+mm).substr(('00'+mm).length - 2,2) + "-" + ('00'+n).substr(('00'+n).length - 2,2) ;//与别一个JS文件接应  // 添加 //
closeLayer(); 
} 
