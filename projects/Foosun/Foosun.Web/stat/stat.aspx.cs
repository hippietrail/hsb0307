...
public partial class stat_stat : Foosun.Web.UI.BasePage
{
    ...
    private void Page_Load(object sender, System.EventArgs e)
    {
        ...
        if (fs_ok_stat)
        {
            ...
            #region 取得访问者的ip信息值
            str_fs_ip = Request.ServerVariables["REMOTE_ADDR"];
            #endregion
            ...
            switch (code)
            {
                ...
                case "2":		//ICON显示一小图标，鼠标放上去自动显示出系统统计到的相关信息
                    str_fs_outstr = "<a href='http://www.hgzp.com' title='" + dv[0].Row["SystemName"].ToString() + "\\n总量: " + str_fs_all1 + "\\n最高访问量: " + inthigh1 + "\\n最高访问量日期: " + strhightime1 + "\\n今日访问: " + str_fs_today1 + "\\n昨日访问: " + str_fs_yesterday1 + "\\n您的访问量: " + str_fs_user_visit;
                ...
                case "0":		//TEXT文本方式显示总数，统计方式比较单一简单。
                    str_fs_outstr = str_fs_all1.ToString();
