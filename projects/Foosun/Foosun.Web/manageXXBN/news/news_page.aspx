    ...
    <form id="form1" runat="server">
        ...
        <table width="98%" align="center" border="0" cellpadding="3" cellspacing="0" class="table">
            ...
            <tr>
                ...
                <td class="TR_BG_list">
                    <asp:TextBox ID="TCname" Width="300" CssClass="form SpecialFontFamily" runat="server"></asp:TextBox>
            ...
            <tr>
                ...
                <td class="TR_BG_list">
                    <span style="display: none;">
                        <asp:TextBox ID="TParentId" runat="server" MaxLength="100" Width="80" CssClass="form SpecialFontFamily"></asp:TextBox><img
                            ...
                            onclick="selectFile('newsclass',document.form1.TParentId,250,500);document.form1.TParentId.focus();" /></span><span
                                id="ClassCnamev" class="reshow SpecialFontFamily"></span>
            ...
            <tr id="rows_key" runat="server">
                ...
                <td class="TR_BG_list">
                    <asp:TextBox ID="KeyMeata" TextMode="MultiLine" Height="50" CssClass="form SpecialFontFamily" Width="500"
            ...
            <tr id="rows_meta" runat="server">
                ...
                <td class="TR_BG_list">
                    <asp:TextBox ID="BeWrite" TextMode="MultiLine" Height="50" CssClass="form SpecialFontFamily" Width="500"
                        runat="server"></asp:TextBox>
                </td>
            </tr>
      ...
      --%>
            ...
            <td style="width: 90%">
                ...
                <asp:TextBox ID="PageTitle" runat="server" Text="" Width="200px" CssClass="SpecialFontFamily"></asp:TextBox>
