...
<body>
    ...
    <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1" class="Navitable">
     ...
     <table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" class="table">
        ...
        <tr class="TR_BG_list">
          <td class="list_link" style="width: 149px"><div align="right">生成数量</div></td> 
          <td class="list_link"><asp:TextBox CssClass="form" ID="cNumber" runat="server" MaxLength="3"  Width="250">100</asp:TextBox>
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_0001',this)">帮助</span>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cNumber" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)生成数量范围1-999</span>"></asp:RequiredFieldValidator>
           <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="cNumber"  Display="Static" ErrorMessage="(*)格式不正确。请填写正整数" ValidationExpression="^[0-9]{0,3}"></asp:RegularExpressionValidator>
         </td></tr>   
             
         <tr class="TR_BG_list">
          <td class="list_link" style="width: 149px"><div align="right">卡号/序列号长度</div></td> 
          <td class="list_link"><asp:TextBox CssClass="form" ID="cardlen" runat="server" MaxLength="2"  Width="250">15</asp:TextBox>
          数字与字符组合 <asp:DropDownList ID="isChar_num" runat="server">
             <asp:ListItem Selected="True" Value="0">否</asp:ListItem>
             <asp:ListItem Value="1">是</asp:ListItem>
         </asp:DropDownList>
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_0001',this)">帮助</span>
          <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="cardlen" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)卡号长度最大为30</span>"></asp:RequiredFieldValidator>
           <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="cardlen"  Display="Static" ErrorMessage="(*)格式不正确。请填写正整数" ValidationExpression="^[0-9]{0,2}"></asp:RegularExpressionValidator>
         </td></tr> 

          <tr class="TR_BG_list">
          <td class="list_link" style="width: 149px"><div align="right">卡号前缀</div></td> 
          <td class="list_link"><asp:TextBox CssClass="form" ID="recard" runat="server" MaxLength="10" Text="FS"  Width="250"></asp:TextBox>
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_00012',this)">帮助</span>
         </td>
         </tr>          
          <tr class="TR_BG_list">
          <td class="list_link" style="width: 149px"><div align="right">密码长度</div></td> 
          <td class="list_link"><asp:TextBox CssClass="form" ID="passlen" runat="server" MaxLength="2"  Width="250">15</asp:TextBox>
          数字与字符组合 <asp:DropDownList ID="pass_card_num" runat="server">
             <asp:ListItem Selected="True" Value="0">否</asp:ListItem>
             <asp:ListItem Value="1">是</asp:ListItem>
            </asp:DropDownList>
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_00013',this)">帮助</span>
           <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="passlen" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)密码长度最大为30</span>"></asp:RequiredFieldValidator>
           <asp:RegularExpressionValidator ID="RegularExpressionValidator5" runat="server" ControlToValidate="passlen"  Display="Static" ErrorMessage="(*)格式不正确。请填写正整数" ValidationExpression="^[0-9]{0,2}"></asp:RegularExpressionValidator>
         </td>
         </tr> 
        ...
        <tr class="TR_BG_list">
          ...
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_0003',this)">帮助</span>
          <asp:RequiredFieldValidator ID="RequiredFieldValidators" runat="server" ControlToValidate="Money" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)金额长度为5</span>"></asp:RequiredFieldValidator>
        ...
        <tr class="TR_BG_list">
          ...
          <span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_0004',this)">帮助</span>
          <asp:RequiredFieldValidator ID="RequiredFieldValidatordd" runat="server" ControlToValidate="Point" Display="Dynamic" ErrorMessage="<span class='reshow'>(*)点数长度为8</span>"></asp:RequiredFieldValidator>
       ...
       <tr class="TR_BG_list">
          ...
          <td class="list_link"><asp:TextBox CssClass="form" ID="TimeOutDate" runat="server" MaxLength="10"  Width="250"></asp:TextBox>&nbsp;<img src="../../sysImages/folder/s.gif" alt="选择点卡过期日期" border="0" style="cursor:pointer;" onclick="selectFile('date',document.form1.TimeOutDate,160,500);document.form1.TimeOutDate.focus();" /><span class="helpstyle" style="cursor:help;" title="点击查看帮助" onclick="Help('H_icard_adds_0006',this)">帮助</span>
              </td>
          </tr>
