<%@ Page Language="C#" ContentType="text/html" ResponseEncoding="utf-8" AutoEventWireup="true" Inherits="manage_Contribution_Constr_SetParamup" Codebehind="Constr_SetParamup.aspx.cs" %>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          <td width="57%"  class="sysmain_navi"  style="PADDING-LEFT: 14px" >
              稿酬设置</td>
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />稿件管理<img alt="" src="../../sysImages/folder/navidot.gif" border="0" />稿酬设置</div></td>
        </tr>
</table>
...
<tr class="TR_BG_list">
    ...
    &nbsp; &nbsp;&nbsp;
    <asp:Button ID="info" runat="server" OnClick="Button1_Click" Text="修  改"  CssClass="form"/>
