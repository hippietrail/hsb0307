<%@ Page Language="C#" AutoEventWireup="true" Inherits="manage_advertisement_adsclass_add" ResponseEncoding="utf-8" Codebehind="adsclass_add.aspx.cs" %>
    ...
    <form id="form1" runat="server">
      <table width="100%" border="0" cellpadding="0" cellspacing="0"  class="toptable">
        <tr>
          ...
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="list.aspx" target="sys_main" class="list_link">广告系统</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />添加分类</div></td>
        </tr>
      </table>
        ...
        <tr class="TR_BG_list">
         ...
         <tr class="TR_BG_list">
          <td class="navi_link" colspan="2"><label><asp:Button ID="Button1" runat="server" Text=" 确 定 " CssClass="form" OnClick="Button1_Click"/></label>      <label><input type="reset" name="UnDo" value=" 重 填 " class="form" /></label></td>
        </tr>
       </table>
