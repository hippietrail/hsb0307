<%@ Page Language="C#" ContentType="text/html" ResponseEncoding="utf-8" AutoEventWireup="true" Inherits="user_arealist_upp" EnableEventValidation="true"  Codebehind="arealist_upp.aspx.cs" %>
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="toptable">
        ...
        <tr>
          ...
          <td width="43%"  class="topnavichar"  style="PADDING-LEFT: 14px" ><div align="left">位置导航：<a href="../main.aspx" target="sys_main" class="list_link">首页</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" /><a href="userdiscuss_list.aspx" class="menulist">地域管理</a><img alt="" src="../../sysImages/folder/navidot.gif" border="0" />省</div></td>
        </tr>
</table>
...
<table width="98%" border="0" align="center" cellpadding="5" cellspacing="1" bgcolor="#FFFFFF" class="table" id="addmanage">
  <tr class="TR_BG_list">
    ...
    <td class="list_link" Width="75%">
        <asp:TextBox ID="cityName" runat="server" Width="314px" CssClass="form"></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="cityName"
            ErrorMessage="请输入大类名称"></asp:RequiredFieldValidator></td>
  </tr>
  ...
  <tr class="TR_BG_list">
    <td class="list_link" Width="25%" style="text-align: right">
        排序：</td> 
        <td class="list_link" Width="75%">
        <asp:TextBox ID="OrderID" runat="server" MaxLength="2" Width="314px" CssClass="form">0</asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="OrderID"
            ErrorMessage="请输入排序号"></asp:RequiredFieldValidator></td>
  </tr>
