...
<head>
    ...
    <script type="text/javascript" src="../../configuration/js/jquery.bgiframe.js"></script>
                ...
                <table width="98%" border="0" align="center" cellpadding="2" cellspacing="1" class="table">
                    ...
                    <tr class="TR_BG_list">
                        ...
                        <td align="left" valign="top" class="navi_link" style="width: 365px;">
                            ...
                            <asp:ListBox ID="divClassNews" Width="97%" runat="server" Rows="20" SelectionMode="Multiple" CssClass="SpecialFontFamily" style="color: steelblue;border-right: white 1px solid; border-top: white 1px solid; border-left: white 1px solid; border-bottom: white 1px solid;">                            </asp:ListBox>
                        ...
                        <td class="navi_link" colspan="2" style="text-align: left">
                           ...
                           <span class="helpstyle" onclick="Help('H_public_index',this);" style="cursor: help" 
                             ...
                             <asp:ListBox ID="divClassClass" runat="server" Rows="30" SelectionMode="Multiple"
                                Width="50%" style="color: steelblue;" CssClass="SpecialFontFamily" ></asp:ListBox>
                             </td>
                    </tr>
                    </table>
