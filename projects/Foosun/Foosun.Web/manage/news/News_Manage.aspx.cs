...
public partial class manage_news_News_Manage : Foosun.Web.UI.ManagePage
{
    ...
    protected void NewsCopy()
    {
        ...
        PageRight("成功将条新闻复制到&nbsp;<font color=red class=\"SpecialFontFamily\">" + sclasstext + "</font>&nbsp;栏目中!", "News_List.aspx");
    }
    #endregion
    /// <summary>
    /// 对选中栏目复制
    ...
    protected void ClassCopy()
    {
        ...
        PageRight("成功将新闻复制到&nbsp;<font color=red  class=\"SpecialFontFamily\">" + sclasstext + "</font>&nbsp;栏目中!", "");
    }
    #endregion
    /// <summary>
    /// 对选中新闻转移
    ...
    protected void NewsMove()
    {
        ...
        PageRight("成功将新闻转移到<font color=red class=\"SpecialFontFamily\">" + sclasstext + "</font>栏目中!", "News_List.aspx");
    }
    #endregion
    /// <summary>
    /// 对选中栏目转移
    ...
    protected void ClassMove()
    {
        ...
        PageRight("成功将新闻转移到<font color=red class=\"SpecialFontFamily\">" + sclasstext + "</font>栏目中!", "");
    }
    #endregion
    /// <summary>
    /// 对选中新闻设置
