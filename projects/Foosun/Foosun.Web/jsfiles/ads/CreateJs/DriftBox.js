...
if(aname.indexOf("Internet Explorer")!=-1){
  if(aver>=4) DriftBoxTF=navigator.javaEnabled();
  DriftBoxStr=true;
}
...
if (document.all){
window.attachEvent('onload',DriftBox)//IEÖÐ
}
else{
window.addEventListener('load',DriftBox,false);//firefox
}
