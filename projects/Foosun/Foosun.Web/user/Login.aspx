...
<form id="form1" name="LoginForm" method="post" action="Index.aspx" runat="server">
  <table width="100%" border="0" cellpadding="0" cellspacing="0" background="../sysImages/Login/top_bg.gif">
    <tr>
      ...
      <td style="height: 55px;width:50%;padding-right:10px;"><div align="right"><a href="http://www.hgzp.com" target="_blank" class="JH">官方站</a>&nbsp;┊&nbsp; <a href="http://www.hgzp.com">技术论坛</a>&nbsp;┊&nbsp;<a href="http://www.hgzp.com">NewsCMS</a>&nbsp;┊&nbsp;<a href="www.hgzp.com" title="专用虚拟主机" target="_blank">资讯数据(IDC)</a>&nbsp;┊&nbsp;<a href="www.hgzp.com" target="_blank">在线帮助</a>&nbsp;┊&nbsp;<a href="www.hgzp.com" target="_blank">开发者中心</a></div></td>
    </tr>
  </table>
