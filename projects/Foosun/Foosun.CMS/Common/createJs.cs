            ...
            if (dt.Rows.Count > 0)
            {
                ...
                else
                {
                    if (dt.Rows[0]["CondiTF"].ToString() == "1")
                    {
                        ...
                        if (int_maxClick == null || int_maxClick == 0)
                        {
                            tftf = tftf && true;
                        }
                        else
                        ...
                        if (int_maxShowClick == null || int_maxShowClick == 0)
                        {
                            tftf = tftf && true;
                        }
                        else
    ...
    public static void CreateAds3(string adsID, string adsClassID)
    {
        ...
        else
        {
            ...
            str_AdsJsstr = "FilterAwayStr=(document.layers)?true:false;if(FilterAwayStr)\r" +
                           ...
                           "<layer id=FilterAwayF position:absolute; top:0; center:1>" + str_Temp + "</layer></layer>');\r" +
                           "}\r" +
                           "else\r" +
                           "{\r" +
                           "document.write('<div style=\"position:absolute;top:0;" +
                           //"document.write('<div style=\"position:absolute;top:" + (int.Parse(str_leftSize[1].ToString()) + 20) + ";" +
    ...
    public static void CreateAds9(string adsID, string adsClassID)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                str_AdsJsstr = "document.write('<marquee onmouseout=\"this.start();\" onmouseover=\"this.stop();\" width=" + arr_leftSize[0].ToString() + " " +
            ...
            if (dv != null)
            {
                if (dv.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < dv.Rows.Count; i++)
                    {
                        ...
                        {
                            str_AdsJsstr += dv.Rows[i]["AdTxt"].ToString();
                        }
                        else
                        {
